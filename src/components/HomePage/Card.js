...
export default function Card(props) {
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",justifyContent:"center",width:"30%",minHeight:"40%",margin: "20px", padding: "10px",boxShadow: "0px 4px 8px rgba(0, 0, 0, 0.2)"}}>
        <div><img style={{width:"80%",height:"80%",margin:"auto",display:"block"}}src={image}/></div>
        <div className='flex-between' style={{display:"flex",flexDirection:"column",marginLeft:"20px",marginRight:"20px", width: "30"}}>
